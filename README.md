...
An example custom node is located in [node.py](src/example_custom_nodepack/nodes.py). To learn more, read the [docs](https://docs.comfy.org/essentials/custom_node_overview).
